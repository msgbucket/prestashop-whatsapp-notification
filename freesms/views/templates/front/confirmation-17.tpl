...
{block name='head_seo_title'}{l s='Order Confirmation' mod='freesms'} | {$shop.name|escape:'html':'UTF-8'}{/block}

{block name='page_title'}
  {l s='Order Confirmation' mod='freesms'}
{/block}

{block name='page_header_container'}
	<header class="page-header"><h1>{l s='Confirm your order' mod='freesms'}: {$order_reference|escape:'html':'UTF-8'}</h1></header>
{/block}
